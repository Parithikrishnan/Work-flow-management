      ...
      <div className="relative w-full max-w-md px-6 pt-10 pb-8 mx-auto shadow-xl bg-slate-800/50 backdrop-blur-md ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10">
        <div className="w-full">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-400">Join us and streamline your workflow</p>
          </div>
          <div className="mt-8">
            <form action="">
              <div className="mb-6">
                <label className="block mb-2 text-sm font-medium text-gray-300" htmlFor="name">Full Name</label>
                <input className="block w-full px-4 py-2 text-white transition border rounded-md shadow-sm bg-slate-700/50 border-slate-600 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="name" type="text" placeholder="Enter your full name" required />
              </div>
              <div className="mb-6">
              ...
              <div className="mb-6">
                ...
                <input className="block w-full px-4 py-2 text-white transition border rounded-md shadow-sm bg-slate-700/50 border-slate-600 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="password" type="password" placeholder="Create a strong password" required />
              </div>
              <div className="mt-8">
              ...
              <div className="mt-6 text-sm text-center">
                ...
                <Link to="/login" className="font-semibold text-indigo-400 hover:underline">Sign In</Link>
              </div>
            </form>
          </div>
        </div>
